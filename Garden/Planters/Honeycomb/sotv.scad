...
h=117;			//	высота цилиндра; cylinder height
n=16;			//	количество сот на окружности; number of cells on the circle
dw=15;		//	расстояние между гранями соты; distance between cell faces
h1=4.8;			//	высота выступа соты; honeycomb height
w=1;		//	промежуток между сотами; cell spacing
an=30;		//	угол наклона заострения соты; angle of tapering cell
