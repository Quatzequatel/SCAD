...
module Test() 
{
    ...
    squareProperties = [[292.1, 292.1], [4, 12.7], [2, 2.08], [2, 2], [2], [true, false, true, false, false, 0, true, false], ["wavetrellis", [10, 50, 0, 2]]];
    ...
    echo(getKeyValue(squareProperties, "wavetrellis"));
